...
<x-dynamic-component :component="$layout">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Directorate Admins') }} - {{ $directorate->name }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between gap-4">
                        <div class="text-sm text-gray-600">DCG is the admin for a directorate (one per directorate).</div>
                        <a href="{{ route('management.directorates.admins.create', $directorate) }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md font-semibold">
                            Add Admin
                        </a>
                    </div>
                    ...
                    <div class="mt-6 overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-4 py-6 text-sm text-gray-500 text-center">No DCG assigned.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
